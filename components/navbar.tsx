  ...
  return (
    <nav className="fixed top-6 inset-x-0 z-[100] px-4 pointer-events-none">
      <div className="container mx-auto">
        <div className="flex justify-between items-center bg-black/40 backdrop-blur-xl border border-white/5 rounded-full px-6 py-2 shadow-2xl pointer-events-auto">
